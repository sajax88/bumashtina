...
export function CalculateTaxForQuarter(arg1:number,arg2:number):Promise<main.CalculatedTax>;
...
export function GetActiveMonthsNumber(arg1:number):Promise<number>;
