...
<main>
    ...
    <div id="home-page-block-right" class="input-box">
        <div class="alert-small">
            <span>Ако искате да генерирате Декларация 1, въведете дохода си във формата отляво или проверете <a href="#/data">въведените данни</a>.</span>
        </div>
            ...
            <div class="form-group">
                ...
                {#if showInsuranceIncomeInfo}
                    <div class="info-popup info-popup-wide" transition:fade={{duration: 200}}>
                        Изберете осигурителен доход между минималния и максималния.<br>
                        В "Годишно изравняване" можете да изчислите окончателния осигурителен доход за годината.
                    </div>
                {/if}
            </div>
        </div>
