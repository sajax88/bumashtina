...
<small>
        Авансовият данък се изчислява за първите три тримесечия и зависи от фактически платени осигуровки.
        В края на годината осигуровките се изравняват и след това се изчислява окончателният данък.
</small>
