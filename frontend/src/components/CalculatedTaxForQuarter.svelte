...
<small>
    <i>
        Точният данък се изчислява за тримесечие и зависи от фактически платени осигуровки.
        В края на годината осигуровките се изравняват и след това се изчислява данъкът за последното тримесечие.
    </i>
</small>
